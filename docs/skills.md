...
| [XActions MCP Server](../skills/xactions-mcp-server/SKILL.md) | 144 MCP tools for AI agents to automate X/Twitter (scrape, post, engage, analyze). |
...
- [MCP Setup](mcp-setup.md) — the 144 tools skills drive
