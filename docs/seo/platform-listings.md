...
XActions includes an MCP (Model Context Protocol) server with 144 tools, making it compatible with Claude Desktop, GPT-4, Cursor, and other AI agents. The CLI tool (`xactions`) provides all features from the terminal.
