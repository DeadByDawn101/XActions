...
```json
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The MCP server lets AI agents like Claude, GPT-4, and Cursor automate X/Twitter actions. It provides 144 tools for scraping, posting, unfollowing, and monitoring."
      }
    },
    {
      "@type": "Question",
